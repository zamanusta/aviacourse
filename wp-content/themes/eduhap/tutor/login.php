...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$eduhap_demo_login_content					 = '';

	if ( isset( $eduhap['eduhap_demo_login_content'] ) ) {
		$eduhap_demo_login_content = $eduhap['eduhap_demo_login_content'];
	}	
	...
	<div class="tutor-template-segment tutor-login-wrap">
		...
		<div class="tutor-login-form-wrapper">
			<div class="tutor-fs-5 tutor-color-black tutor-mb-32">
				<?php esc_html_e( 'Hi, Welcome back!', 'eduhap' ); ?>
				<?php if($eduhap_demo_login_content):?>
				<div class="demo-login-info">
					<?php echo eduhap_wp_kses($eduhap_demo_login_content);?>
				</div>
				<?php endif; ?>
			</div>
			<?php
